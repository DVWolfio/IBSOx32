...
void CaseConvertion()
{
	...
	PluginDialogBuilder Builder(Info, MainGuid, DialogGuid, MDialogTitle, L"Contents", DlgProc);
	/*
	...
	*/
	FarDialogItem *Edit1 = Builder.AddEditField(Opt.Server, MAX_SERVER_SIZE, 20, L"IBSOx32_Server_History");
	FarDialogItem *Edit2 = Builder.AddEditField(Opt.Owner, MAX_OWNER_SIZE, 20);
	FarDialogItem *Edit3 = Builder.AddEditField(Opt.User, MAX_USER_SIZE, 20);
	FarDialogItem *Edit4 = Builder.AddPasswordField(Opt.Password, MAX_PWD_SIZE, 20);
